...
ActionKey_enter_Down("Key_e")
HKPost("Key_e")
return
Label_e_up:
HKUpPre()
ActionKey_enter_Up("Key_e")
...
Label_x_down:
HKPre()
ActionKey_u_Down("Key_x")
HKPost("Key_x")
return
Label_x_up:
HKUpPre()
ActionKey_u_Up("Key_x")
HKUpPost("Key_x")
return
...
LabelMap2_d_down:
HKPre()
ActionKey_f3_Down("Key_d")
HKPost("Key_d")
return
LabelMap2_d_up:
HKUpPre()
ActionKey_f3_Up("Key_d")
HKUpPost("Key_d")
return
...
LabelMap2_z_down:
HKPre()
ActionKey_f6_Down("Key_z")
HKPost("Key_z")
return
LabelMap2_z_up:
HKUpPre()
ActionKey_f6_Up("Key_z")
HKUpPost("Key_z")
return

LabelMap2_x_down:
HKPre()
ActionKey_f7_Down("Key_x")
HKPost("Key_x")
return
LabelMap2_x_up:
HKUpPre()
ActionKey_f7_Up("Key_x")
HKUpPost("Key_x")
return

LabelMap2_c_down:
HKPre()
ActionKey_f8_Down("Key_c")
HKPost("Key_c")
return
LabelMap2_c_up:
HKUpPre()
ActionKey_f8_Up("Key_c")
HKUpPost("Key_c")
return

LabelMap2_v_down:
HKPre()
ActionKey_f9_Down("Key_v")
HKPost("Key_v")
return
LabelMap2_v_up:
HKUpPre()
ActionKey_f9_Up("Key_v")
HKUpPost("Key_v")
return

LabelMap2_b_down:
HKPre()
ActionKey_f10_Down("Key_b")
HKPost("Key_b")
return
LabelMap2_b_up:
HKUpPre()
ActionKey_f10_Up("Key_b")
HKUpPost("Key_b")
return

LabelMap2_w_down:
HKPre()
ActionKey_f11_Down("Key_w")
HKPost("Key_w")
return
LabelMap2_w_up:
HKUpPre()
ActionKey_f11_Up("Key_w")
HKUpPost("Key_w")
return

LabelMap2_r_down:
HKPre()
ActionKey_f12_Down("Key_r")
HKPost("Key_r")
return
LabelMap2_r_up:
HKUpPre()
ActionKey_f12_Up("Key_r")
HKUpPost("Key_r")
return
...
LabelMap3_b_down:
HKPre()
ActionKey_l_Down("Key_b")
HKPost("Key_b")
return
LabelMap3_b_up:
HKUpPre()
ActionKey_l_Up("Key_b")
HKUpPost("Key_b")
return

LabelMap3_t_down:
HKPre()
ActionKey_f_Down("Key_t")
HKPost("Key_t")
return
LabelMap3_t_up:
HKUpPre()
ActionKey_f_Up("Key_t")
HKUpPost("Key_t")
return

LabelMap3_q_down:
HKPre()
ActionKey_o_Down("Key_q")
HKPost("Key_q")
return
LabelMap3_q_up:
HKUpPre()
ActionKey_o_Up("Key_q")
HKUpPost("Key_q")
return
