...
Label_b_down:
HKPre()
ActionKey_f_Down("Key_b")
HKPost("Key_b")
return
Label_b_up:
HKUpPre()
ActionKey_f_Up("Key_b")
HKUpPost("Key_b")
return
...
Label_x_down:
HKPre()
ActionKey_numpad3_Down("Key_x")
HKPost("Key_x")
return
Label_x_up:
HKUpPre()
ActionKey_numpad3_Up("Key_x")
HKUpPost("Key_x")
return

Label_vkdb_down:
HKPre()
ActionKey_vkdb_Down("Key_vkdb")
HKPost("Key_vkdb")
return
Label_vkdb_up:
HKUpPre()
ActionKey_vkdb_Up("Key_vkdb")
HKUpPost("Key_vkdb")
return

Label_vkdd_down:
HKPre()
ActionKey_vkdd_Down("Key_vkdd")
HKPost("Key_vkdd")
return
Label_vkdd_up:
HKUpPre()
ActionKey_vkdd_Up("Key_vkdd")
HKUpPost("Key_vkdd")
return
...
Label_1_down:
HKPre()
ActionKey_tab_Down("Key_1")
HKPost("Key_1")
return
Label_1_up:
HKUpPre()
ActionKey_tab_Up("Key_1")
HKUpPost("Key_1")
return
...
LabelMap2_t_down:
HKPre()
ActionKey_t_Down("Key_t")
HKPost("Key_t")
return
LabelMap2_t_up:
HKUpPre()
ActionKey_t_Up("Key_t")
HKUpPost("Key_t")
return
...
LabelMap2_s_down:
HKPre()
ActionKey_vkbf_Down("Key_s")
HKPost("Key_s")
return
LabelMap2_s_up:
HKUpPre()
ActionKey_vkbf_Up("Key_s")
HKUpPost("Key_s")
return
